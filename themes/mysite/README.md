# `mysite` Theme
><small>Welcome to `mysite`, your custom [**Omega Five**](https://drupal.org/project/omega) subtheme! 
...
> You'll find that the `mysite` theme has a vast coverage of inline documentation. 
...
You will find links to **Install** and **Install and set as default** listed with `mysite`.

## Customizing Libraries in `mysite`
...
mysite:
  omega:
    ...
    title: 'Default library for the mysite theme'
    description: 'Default Omega subtheme library description. Please provide a more meaningful description (and title) for this library by editing the mysite.libraries.yml file.'
    scss:
      style/css/mysite.css: 'style/scss/mysite.scss'
  version: VERSION
  js:
    js/mysite.js: {}
  css:
...
Above, you will see the library defined as: `mysite/mysite`. 
